...
abstract class TestCase extends Orchestra
{
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $app['config']->set('beem-africa.checkout.api_key', 'test_api_key');
        $app['config']->set('beem-africa.checkout.secret_key', 'test_secret_key');
        $app['config']->set('beem-africa.checkout.base_url', 'https://checkout.beem.africa');
        $app['config']->set('beem-africa.checkout.webhook_secret', null);
    }
}
