...
/**
 * Data Transfer Object for collection balance response.
 */
class CollectionBalance
{
    ...
    {
        // Handle nested response format: {"code": {"credit_bal": "5300.0000"}}
        $balance = '0';

        if (isset($data['code']['credit_bal'])) {
            $balance = (string) $data['code']['credit_bal'];
